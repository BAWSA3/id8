...
words. The desk interrogates it, tests it against the live Nansen tape, and
hands you back a doc with receipts. It never writes the trade.
...
The hard rule: every substantive word on the book is typed by the trader.
The agents ask, structure, surface, and argue; they never suggest a coin, an
entry, an exit, or a size.

Built solo with Claude Code on Next.js and Vercel. Nansen is the evidence
layer; Dexscreener supplies pool context only.
